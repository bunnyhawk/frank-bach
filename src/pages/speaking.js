    ...
    return (
      <Layout location={this.props.location}>
        ...
        <Container isNarrow className="pb-24">
          <div className="flex items-center mt-40 mb-14">
            <h1
              className="w-full"
          ...
          <p className="font-light text-lg mt-10 mx-auto w-5/6">{speakingContent.speakingTitle}</p>
          <div className="flex items-center">
            <img className="w-4/12 pr-4" src="/speaking-joy.png" alt="Frank speaking at a conference" />
            <div className="w-8/12">
              ...
              <Link to="/" className="text-blu text-sm">Learn More &#8594;</Link>
            </div>
          </div>
          <div className="flex items-center">
            ...
            <img className="w-4/12 pl-4" src="/speaking-mindful.png" alt="Frank speaking at a conference" />
          </div>
          <div className="flex items-center">
            <img className="w-4/12 pr-4" src="/speaking-apex.png" alt="Frank speaking at a conference" />
            <div className="w-8/12">
